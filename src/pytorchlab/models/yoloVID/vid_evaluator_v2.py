...
from src.pytorchlab.utils.yoloVID import (
    gather,
    is_main_process,
    postprocess,
    synchronize,
...
class VIDEvaluator:
    ...
    def __init__(
        ...
        self.vid_to_coco = {
            ...
            'annotations': [],
            'categories': [{"supercategorie": "", "id": 0, "name": "yaobian"},
                           {"supercategorie": "", "id": 1, "name": "shaochuanduanhu"},
                           {"supercategorie": "", "id": 2, "name": "qikong"},
                           {"supercategorie": "", "id": 3, "name": "jiazha"},
                           {"supercategorie": "", "id": 4, "name": "weihantou"},
                           {"supercategorie": "", "id": 5, "name": "weironghe"},
                           {"supercategorie": "", "id": 6, "name": "liewen"}],
            'images': [],
            'licenses': []
        }
